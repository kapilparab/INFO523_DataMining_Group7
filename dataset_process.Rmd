...
accident_clean <- person_data %>%   
  ...
  mutate(
    across(c("VPICMAKENAME", "VPICMODELNAME", "VPICBODYCLASSNAME"),
...
motorcycle <- accident_clean %>% 
  ...
  select("CASE_ID", "STATE", "COUNTY", "VEH_MOD_YEAR", "VEH_BRAND", "VEH_MODEL", "VEH_CATEGORY", "LATITUDE", "LONGITUDE", "ACC_TS", "ACC_TOD", "ACC_LOC", "LIGHT_COND", "WEATHER", "AGE", "SEX", "DRINKING_FLAG", "DRUGS_FLAG", "SEAT_POS", "IMPACT_LOC", "FIRE_FLAG", "HARM_EV_TYPE", "COLL_EV_TYPE", "HELMET_PRESENT", "HELMET_MISUSE", "IS_DEAD")
